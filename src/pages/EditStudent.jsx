...
const EditStudent = ()=>{
    ...
    useEffect(()=>{
        ...
        axios.get(`https://686f91df91e85fac42a19a24.mockapi.io/Students/data/students/${id}`).then((res)=>{
            console.log(res)
   ...
   const editedStudent={
    ...
    axios.put(`https://686f91df91e85fac42a19a24.mockapi.io/Students/data/students/${id}`, editedStudent).then(()=>{
