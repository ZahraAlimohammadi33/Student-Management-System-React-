...
const HomePage= ()=>{
  ...
  const api = 'https://686f91df91e85fac42a19a24.mockapi.io/Students/data/students'
   useEffect(() => {
   ...
   const deleteHandler = (id)=>{
        ...
        dispatch({ type: 'remove', payload: id})}).then(() => {
        alert('deleted')
      });
   }
   ...
   const executScroll= ()=>{
    ...
    return(
        <div style={{display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
                 <input type="text" value={searchBarValue} onChange={searchFilterHandler} className="search-bar" ref={elementRef} placeholder="اسمشو وارد کن . . " />
                           <Button
                               type="toggle"
