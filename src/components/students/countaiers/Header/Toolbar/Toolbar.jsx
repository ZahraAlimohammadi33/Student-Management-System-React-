...
const Toolbar =()=>{
    ...
    return (
        ...
        <header className="Toolbar">
            ...
            <div className="helper show"><Logo/></div>
            <nav className="show">
                <MenuItems> 
                </MenuItems>
            </nav>
            {authenticated ? <Button className='show' type='login' function={logout}>خروج</Button> : <Button className='show' type='login' function={modalHandler}>ورود</Button>}
