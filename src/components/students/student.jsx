...
const Student = (props)=>{
    return (
        <div className='students'>
            ...
            <Button type={'danger'} function={props.deleted}>حذف</Button>
...
const NewStudent=(props)=>{
     ...
     const handleAdd=()=>{
        props.added(nameRef.current.value,classRef.current.value,phoneRef.current.value,emailRef.current.value)
     ...
     <div className='students'>
            ...
            <label>
            <Button type={'success'} function={handleAdd}>افزودن</Button>
            </label>
        </div>
        )
}
